    ...
    <header className="bg-white shadow-md">
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md">
          <a href="/" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">首页</a>
          <a href="/about" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">关于我们</a>
          <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">服务</a>
          <a href="/contact" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">联系我们</a>
        </div>
      )}
    </header>
  );
